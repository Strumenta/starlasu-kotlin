...
class LionWebLanguageConverterTest {
    ...
    fun exportSimpleLanguage() {
        ...
        assertEquals(listOf(ASTLanguage.getInstance().astNode), simpleRoot.implemented)
        ...
        assertEquals(
            listOf(ASTLanguage.getInstance().astNode, ASTLanguage.getInstance().entityDeclaration),
            simpleDecl.implemented,
        )
        assertEquals(null, simpleRoot.extendedConcept)
    ...
    fun exportSimpleLanguageWithPartitions() {
        ...
        assertEquals(listOf(ASTLanguage.getInstance().astNode), myNonPartition.implemented)
