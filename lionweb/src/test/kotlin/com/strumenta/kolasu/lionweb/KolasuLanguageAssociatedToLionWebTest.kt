...
class KolasuLanguageAssociatedToLionWebTest {
    ...
    fun conceptsAreAssociatedWithRightKey() {
        ...
        val lwRoot = Concept(lwLang, "Root", "c-123").apply {
            setKey("key-123")
        }
        val lwNodeA = Concept(lwLang, "NodeA", "c-456").apply {
            setKey("key-456")
        }
        val lwNodeB = Concept(lwLang, "NodeA", "c-789").apply {
            setKey("key-789")
        }
        val lwEnum = Enumeration(lwLang, "MyEnum", "c-000").apply {
            setKey("key-000")
        }
