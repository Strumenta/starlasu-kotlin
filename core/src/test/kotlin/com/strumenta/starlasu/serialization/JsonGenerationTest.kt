...
import com.strumenta.starlasu.model.BaseNode
import com.strumenta.starlasu.model.ExtNode
import com.strumenta.starlasu.model.Internal
import com.strumenta.starlasu.model.Multiplicity
import com.strumenta.starlasu.model.Node
import com.strumenta.starlasu.model.NodeOverridingName
...
class JsonGenerationTest {
  ...
  "issues": [
    ...
    fun generateJson() {
        ...
        assertEquals(
            """{
  "#type": "com.strumenta.starlasu.serialization.MyRoot",
  "mainSection": {
    "#type": "com.strumenta.starlasu.serialization.Section",
    "contents": [
      {
        "#type": "com.strumenta.starlasu.serialization.Content",
        "_id": 1
      },
      {
        "#type": "com.strumenta.starlasu.serialization.Content",
  ...
  "otherSections": []
    ...
    fun generateJsonWithStreaming() {
        ...
        assertEquals(
            """{"#type":"com.strumenta.starlasu.serialization.MyRoot",
                |"mainSection":{"#type":"com.strumenta.starlasu.serialization.Section","contents":
                |[{"#type":"com.strumenta.starlasu.serialization.Content","_id":1},
                |{"#type":"com.strumenta.starlasu.serialization.Content","_id":2,
                |"annidatedContent":{"#type":"com.strumenta.starlasu.serialization.Content","_id":3,
                |"annidatedContent":{"#type":"com.strumenta.starlasu.serialization.Content","_id":4}}}],
    ...
    fun nodeWithReferenceStreaming() {
        ...
        assertEquals(
            """{
            |"#type":"com.strumenta.starlasu.serialization.NodeWithReference",
            |"children":[],
    ...
    fun duplicatePropertiesStreaming() {
        ...
        val json = writer.toString()
        assertEquals(
            """{"#type":"com.strumenta.starlasu.model.NodeOverridingName","name":"foo"}
            """.trimMargin().replace("\n", ""),
            json,
        )
    }
    ...
    fun duplicatePropertiesInheritedByInterface() {
        ...
        assertEquals(
            """{
  "#type": "com.strumenta.starlasu.model.NodeOverridingName",
  "name": "foo"
}""",
            json,
        )
    ...
    fun duplicatePropertiesInheritedByClass() {
        ...
        assertEquals(
            """{
  "#type": "com.strumenta.starlasu.model.ExtNode",
  "attr1": 123
}""",
            json,
        )
    ...
    fun dynamicNode() {
        val node =
            DynamicNode(
                "com.strumenta.starlasu.test.Node",
                listOf(
                    PropertyDescription(
                        "someAttr",
        ...
        assertEquals(
            """
            {
              "#type": "com.strumenta.starlasu.test.Node",
              "someAttr": 123,
              "someListAttr": [
                "a",
                "b"
              ...
              "someChild": {
                "#type": "com.strumenta.starlasu.model.BaseNode",
                "attr1": 456
              },
              "someChildren": [
                {
